...
7. The na_example vector represents a series of counts. You can quickly examine the object using: *still working*
```{r}
data("na_example")
str(na_example)
```

8. Now compute the average again, but only for the entries that are not NA. Hint: remember the ! operator. *still working*
